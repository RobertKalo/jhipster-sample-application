    ...
    describe('UnitOfMeasure Service', () => {
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/unit-of-measures';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a UnitOfMeasure', () => {
                service.create(new UnitOfMeasure(null)).subscribe(received => {
            ...
            it('should update a UnitOfMeasure', () => {
                service.update(new UnitOfMeasure(123)).subscribe(received => {
            ...
            it('should return a UnitOfMeasure', () => {
            ...
            it('should return a list of UnitOfMeasure', () => {
                ...
                const req = httpMock.expectOne({ method: 'GET' });
                req.flush([new UnitOfMeasure(123)]);
            });
